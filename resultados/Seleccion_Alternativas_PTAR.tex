...
{\Large\textbf{Caudal de Diseno:} 10.0 L/s}
...
\node at (5,2) {Planta de Tratamiento de Aguas Residuales};
\node at (5,1) {\textbf{Ubicacion:} Por definir};
\end{tikzpicture}

\vfill

{\large Fecha: 27/03/2026}
...
Se han identificado y evaluado 1 alternativas de tratamiento, 
considerando aspectos tecnicos, economicos y operativos para la seleccion de la 
mejor opcion.

El caudal de diseno considerado es de 10.0 L/s, 
distribuido en dos lineas paralelas de 5.0 L/s cada una.
...
\midrule
Caudal total (Q) & 10.0 & L/s & Diseno del proyecto \\
Caudal por linea & 5.0 & L/s & 2 lineas paralelas \\
Caudal por linea & 432 & m$^3$/d & $Q \times 86.4$ \\
DBO$_5$ & 243.1 & mg/L & Caracterizacion agua residual \\
DQO & 498.0 & mg/L & Caracterizacion agua residual \\
SST & 156.0 & mg/L & Caracterizacion agua residual \\
Coliformes fecales & $1 \times 10^7$ & NMP/100mL & Aguas residuales municipales \\
Temperatura & 25.6 & $^\circ$C & Promedio anual Galapagos \\
...
\begin{itemize}
    ...
    \item Cada linea atiende 5.0 L/s
...
\midrule
DBO$_5$ & 243.1 mg/L & $\leq$ 100 mg/L & $\geq$ 60\% \\
DQO & 498.0 mg/L & $\leq$ 200 mg/L & $\geq$ 60\% \\
SST & 156.0 mg/L & $\leq$ 100 mg/L & $\geq$ 60\% \\
...
\begin{enumerate}
    \item Se han evaluado 1 alternativas tecnologicas 
    para el tratamiento de 10.0 L/s de aguas residuales.

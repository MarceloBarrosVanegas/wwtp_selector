...
{\LARGE\bfseries Prueba Frio\par}
\vspace{2cm}
...
Este documento presenta el dimensionamiento detallado del Prueba Frio, diseñado para tratar un caudal de 17.0 L/s distribuido en 3 líneas paralelas (5.67 L/s por línea).

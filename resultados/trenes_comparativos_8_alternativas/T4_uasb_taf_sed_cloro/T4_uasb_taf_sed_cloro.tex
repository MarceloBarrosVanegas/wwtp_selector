...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{T4 – Rejillas + Desarenador + UASB + TAF + Sedimentador Secundario + Cloro + Lecho de Secado}
\fancyhead[R]{\thepage}
...
{\LARGE\bfseries T4 – Rejillas + Desarenador + UASB + TAF + Sedimentador Secundario + Cloro + Lecho de Secado\par}
\vspace{2cm}
...
Este documento presenta el dimensionamiento detallado del T4 – Rejillas + Desarenador + UASB + TAF + Sedimentador Secundario + Cloro + Lecho de Secado, disenado para tratar un caudal de 17.31 L/s distribuido en 3 lineas paralelas (5.77 L/s por linea).

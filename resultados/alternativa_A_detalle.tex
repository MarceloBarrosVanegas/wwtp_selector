...
\begin{equation}
A_{lecho} = \frac{0.756 \times 15}{0.30 \times 2} = 18.9 \text{ m}^2 \text{ por lecho}
\end{equation}

Con una relación largo/ancho de 3:1, las dimensiones resultantes son 7.5 m de largo por 2.5 m de ancho por celda.
...
\begin{equation}
\rho_S = \frac{M_{SST} \times 365}{A_{lecho}} = \frac{15.12 \times 365}{18.9} = 146.0 \text{ kg SST/m}^2\text{·año}
\end{equation}
...
\midrule
DBO$_5$ (mg/L) & 250.0 & 75.0 & 60.5 & 42.3 & 42.3 \\
DQO (mg/L) & 500.0 & 175.0 & 144.4 & 101.1 & 101.1 \\
SST (mg/L) & 250.0 & 75.0 & 30.0 & 6.0 & 6.0 \\
...
El área de tratamiento calculada (unidades mas margenes minimos) es de aproximadamente 888 m². Sin embargo, para una operacion adecuada se requieren areas complementarias adicionales.

\textbf{Areas complementarias requeridas}

El area calculada de 888 m$^2$ corresponde unicamente a las unidades de tratamiento con sus margenes minimos de acceso. Sin embargo, para garantizar una operacion segura y eficiente de la planta durante toda su vida util, es necesario prever espacios adicionales para acceso vehicular y peatonal de operarios y visitantes, almacenamiento seguro de productos quimicos y herramientas, realizacion de analisis de control de calidad in-situ, estacionamiento para personal y visitantes, circulacion interna de vehiculos de mantenimiento y retiro de lodos, separacion de limites con zonas verdes para control de olores, y espacios administrativos para control operativo. La siguiente tabla resume las areas complementarias necesarias:
...
Considerando el area de tratamiento (888 m$^2$), amortiguacion (20\%), complementarias operativas y zona verde (15\% del total):
...
\begin{itemize}[noitemsep,leftmargin=2em]
    \item[$A_{tratamiento}$] = 888 m$^2$
    \item[$A_{amortiguacion}$] = 178 m$^2$ (20\%)
    \item[$A_{complementarias}$] = 280--340 m$^2$ (operativas)
\end{itemize}

\begin{equation}
A_{total} = \frac{888 + 178 + 310}{0.85} \approx \mathbf{1600 \text{--} 1900 \text{ m}^2} \approx \mathbf{0.16 \text{--} 0.19 \text{ ha}}
\end{equation}
...
\midrule
Rejillas & 0.60 m $\times$ 0.40 m & 2 canales & Velocidad: 0.50 m/s \\
Desarenador & 0.60 m $\times$ 3.0 m $\times$ 0.7 m & 2 unidades & TRH: 30 s \\
Reactor UASB & D = 5.50 m, H = 3.6 m & 2 unidades & v$_{up}$ = 0.76 m/h \\
Filtro Percolador & D = 6.56 m, H = 4.3 m & 2 unidades & Q$_A$ = 4.00 m$^3$/m$^2\cdot$h \\
Sedimentador Secundario & D = 5.87 m, H = 3.5 m & 2 unidades & SOR = 15.9 m$^3$/m$^2\cdot$d \\
Desinfeccion (Cloro) & 4.2 m $\times$ 1.1 m $\times$ 2.3 m & 2 unidades & CT = 15 mg$\cdot$min/L \\
Lecho de Secado & 18.9 m$^2$ (7.5 m $\times$ 2.5 m) & 2 unidades & Carga: 15.1 kg SST/d \\
\bottomrule
\end{tabular}
\end{table}
...
CF (NMP/100mL) & 10000000 & 7000000 & 5600000 & 5040000 & 2526 \\
\midrule
\textbf{Remocion etapa} & -- & \textbf{70\%} & \textbf{19\%} & \textbf{30\%} & \textbf{83.1\%} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
DBO$_5$ & 42.3 mg/L & $\leq$ 100 mg/L & \textcolor{green}{\textbf{CUMPLE}} \\
DQO & 101.1 mg/L & $\leq$ 250 mg/L & \textcolor{green}{\textbf{CUMPLE}} \\
SST & 6.0 mg/L & $\leq$ 130 mg/L & \textcolor{green}{\textbf{CUMPLE}} \\
Coliformes fecales & 2526 NMP/100mL & $\leq$ 3,000 NMP/100mL & \textcolor{green}{\textbf{CUMPLE}} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Area de tratamiento & 888 m$^2$ \\
Area de amortiguacion (20\%) & 178 m$^2$ \\
Area complementaria operativa & 310 m$^2$ \\
Zona verde (15\% del total) & 133 m$^2$ \\
\midrule
\textbf{Area total requerida} & \textbf{888--1900 m$^2$ (0.16--0.19 ha)} \\
\bottomrule
\end{tabular}
\end{table}
...
Area de lechos de secado & 18.9 m$^2$ (2 unidades) \\

...
Comparación con el umbral mínimo: $Q_{brazo} = 22.5$ m³/h $\geq$ 10 m³/h (Rotación hidráulica garantizada)

La rotación hidráulica está garantizada sin necesidad de motor auxiliar.
...
\begin{itemize}[noitemsep,leftmargin=2em]
    \item Velocidad calculada: $v = 2.00$ m/s

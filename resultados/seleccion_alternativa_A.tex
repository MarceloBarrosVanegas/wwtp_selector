...
\textbf{Verificación hidráulica para caudal máximo:} Metcalf y Eddy \cite{metcalf2014} establecen límites de velocidad ascendente para proteger el manto de lodos durante condiciones de pico de caudal. Según estos autores, velocidades superiores a 1.5 m/h pueden provocar arrastre del manto, mientras que valores mayores a 2.0 m/h causan pérdida severa de biomasa. La velocidad calculada $v_{up,max} = 1.07$~m/h se evalúa según los siguientes criterios de diseño:
